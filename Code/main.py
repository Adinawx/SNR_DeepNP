...
def run(
    ...
    '''
    # Run Inputs:
    run_flag:   'plot', 'train', 'test', 'train_and_test', 'test_robust'
    rtt_list: [time-steps]
...
if __name__ == '__main__':
    run(
        project_folder=r"C:\Users\adina\Technion\Research\SINR\FromServer",  # Code Folder
        ...
        loss_type_list=['MB'],  # [M, B, MB] - For Deep Model Est
